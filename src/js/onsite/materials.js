  ...
  materialRowsEl.innerHTML = appState.materialLines.map((ln, i) => {
    ...
    return `
      ...
      <div class="md:hidden p-4 bg-white rounded-xl border border-slate-200 shadow-md hover:shadow-lg transition-shadow duration-200 space-y-4">
        ...
        <!-- Remove Button -->
        <button data-del="${i}" class="w-full py-3 text-base rounded-lg border-2 border-red-200 bg-red-50 text-red-700 hover:bg-red-100 hover:border-red-300 transition-all duration-200 font-semibold flex items-center justify-center gap-2">
      ...
      <tr class="hidden md:table-row border-b border-slate-100 ${i % 2 === 0 ? 'bg-white hover:bg-emerald-50/50' : 'bg-slate-50/50 hover:bg-emerald-50'} transition-colors duration-200">
        ...
        <td class="py-3 px-3 text-right">
          <button data-del="${i}" class="text-sm px-3 py-1.5 rounded-lg border-2 border-red-200 bg-red-50 text-red-700 hover:bg-red-100 hover:border-red-300 transition-all duration-200 font-semibold flex items-center gap-1.5 ml-auto">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
            </svg>
            Remove
