/**
 * Workshop Calculator - Saved Records UI Module
 * Handles rendering and UI interactions for saved workshop records
 */
...
/**
 * Render records grid in card view (workshop-specific, no calculator type badge)
...
/**
 * Render records as a table list view (workshop-specific)
 * @param {Array} records - Records to render
 */
...
/**
 * Display record detail in read-only mode (workshop-specific)
...
export function displayRecordDetail(record) {
  ...
  // Build detail HTML (workshop-specific - no onsite fields)
  const detailHtml = `
