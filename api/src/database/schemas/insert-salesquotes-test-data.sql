...
INSERT INTO BCAssignedUsers (UserId, Email, Branch, Active) VALUES
('USER001', 'alice.m@example.com', 'Management', 1),
('USER002', 'bob.t@example.com', 'Technical', 1),
('USER003', 'carol.s@example.com', 'Sales', 1),
('USER004', 'david.e@example.com', 'Engineering', 1),
('USER005', 'eve.s@example.com', 'Support', 1);
GO

-- Verify data
SELECT SalespersonCode, SalespersonName, Email, Active FROM BCSalespeople;
SELECT UserId, Email, Branch, Active FROM BCAssignedUsers;
GO
