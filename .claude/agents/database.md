...
6. **SalesQuoteApprovals** - Sales Quote approval workflow
   - Id (PK, auto-increment)
   - SalesQuoteNumber (unique)
   - SalespersonEmail
   - SalespersonCode
   - SalespersonName
   - CustomerName
   - WorkDescription
   - TotalAmount
   - ApprovalStatus (Draft, SubmittedToBC, PendingApproval, Approved, Rejected, Revise, Cancelled)
